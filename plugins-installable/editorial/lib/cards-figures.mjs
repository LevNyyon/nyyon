...
export async function judgeCandidateImages(api, { candidates = null, title = null, blog_slug = null, slug = null } = {}) {
  ...
  try {
    // The host llm gateway on this install offers text and json, not vision,
    // so image judging is skipped and the first candidate wins. Said plainly
    // in the report rather than pretending a choice was made.
    report = { skipped: 'image judging needs vision, which this install does not have' };
    const raw = null;
