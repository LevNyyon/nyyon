...
const SOURCE_DOCS = [
  { key: 'company_profile',      slug: 'plugin-editorial-company-profile',   label: 'Company profile' },
  { key: 'plugin-editorial-icp',                  slug: 'plugin-editorial-icp',               label: 'ICP', alt: 'plugin-editorial-icp' },
  { key: 'pov_library',          slug: 'plugin-editorial-hottakes-pov-library',       label: 'Point-of-view library', alt: 'plugin-editorial-hottakes-pov-library' },
...
const SCOUT_DEFAULTS = Object.freeze({
  ...
  themes:             ['general', 'industry', 'competitor', 'plugin-editorial-brand', 'market', 'technology'],
  placeholder_markers: [
    'REQUIRED.',
