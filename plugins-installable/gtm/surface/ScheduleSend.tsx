...
// behind "pick a time…" and send-now as the quiet last row. Used by the
// Outreach conversations composer so scheduling reads the same everywhere.
//
// All times are computed and displayed in the timezone the plugin-gtm-schedule
...
// sibling (it had no other consumers in the host).
