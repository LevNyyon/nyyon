...
// notes, status (approve = 'scheduled', hold = 'ready', skip =
...
export const def = {
  ...
  description: 'Patch one Hot Takes release leg (a social post): body, notes, status or scheduled_at. Approving is status:"scheduled" — the one state the hourly due-scan sends; "ready" holds it back; "not_planned" skips it.',
  input_schema: {
    type: 'object',
    properties: {
      id:           { type: 'string' },
