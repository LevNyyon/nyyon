...
import { SitePreview, PreviewModePill } from '../components/SitePreview';
import { useChatState, openChat, navigateTo } from '../lib/chat';
import { LinkedIn, Trash } from '../components/Icons';
// Shared article UI (also used by the Hot Takes Publications tab) — one
// implementation of the thumbnail, tags, meta rows, and the in-place editor.
import { devUrl, fmtDate, timeAgo, fmtNum, Thumb, TagList, KV, ColHeader, InlineBodyEditor } from '../components/ArticleBits';
...
export function Blog() {
  ...
  async function draftSocial(post: BlogPostWithTags) {
    ...
    try {
      ...
      // ok:false with HTTP 200 — don't brief Nyo about drafts that don't exist.
