// Shared "live preview" iframe with a built-in health probe. Used by the Blog
// surface and the Hot Takes Publications tab — every place the editorial pack
// shows the public site. Moved verbatim from the host's
// components/SitePreview.tsx (its only consumers travel with this pack).
//
...
// Used to flip the preview iframe between unpublished drafts and what real
// visitors see. Two dots + labels — single thing the operator scans without
// reading.
